        ...
        <div class="row q-col-gutter-sm">
          ...
          <div class="col-12 col-sm-9 col-md-10">
            <u-data-table
              ...
              v-model:rows-selected="model.genesSelected"
...
export default {
  ...
  data() {
    return {
      filtersCriteria: this.model.genesFiltersCriteria,
      filtersContext: this.model.genesFiltersContext,
    };
  },

  methods: {
    async fetchData() {
      return await api.searchGenes(this.specimen.id, this.filtersCriteria.toSearchCriteria());
    },

    clearSelection() {
      this.model.genesSelected = [];
    }
  }
}
</script>