  ...
  <div class="col q-gutter-y-sm">
    <div class="row" v-if="specimen && donor">
      ...
      <u-delete-button
        ...
        :id="specimen.id"
        :reference="specimen.referenceId"
        @deleted="$router.push({name: Settings.lines.domain})">
      </u-delete-button>
    </div>
          ...
          <div class="col">
            <q-tab-panels v-model="tab" class="fit">
              ...
              <q-tab-panel :name="Tabs.sms.domain" class="q-py-sm q-px-none">
                <u-sms-tab title="Specimen Simple Mutations (SM)" :area="Settings.line.domain" :samples="samples" :show-samples="false" />
              </q-tab-panel>
