  ...
  <div class="col">
    <u-data-table
      ...
      <template v-slot:body-cell-id="props">
        <q-td :props="props">
          <u-specimen-link :id="props.value" type="cell" />
        </q-td>
      </template>

      <template v-slot:body-cell-donorId="props">
        <q-td :props="props" type="cell">
      ...
      <template v-slot:body-cell-parentId="props">
        <q-td :props="props">
          <u-specimen-link v-if="props.value.id" :id="props.value.id" :type="getSpecimenType(props.value)" />
        </q-td>
      </template>
    </u-data-table>
  </div>
