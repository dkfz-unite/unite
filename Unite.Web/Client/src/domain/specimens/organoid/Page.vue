          ...
          <div class="col">
            <q-tab-panels v-model="tab" class="fit">
              ...
              <q-tab-panel :name="Tabs.ssms.domain" class="q-py-sm q-px-none">
                <u-ssms-tab title="Specimen Simple Somatic Mutations (SSM)" :area="Settings.orgaoid.domain" :samples="samples" :show-samples="false" />
              </q-tab-panel>

              <q-tab-panel :name="Tabs.cnvs.domain" class="q-py-sm q-px-none">
                <u-cnvs-tab title="Specimen Copy Number Variants (CNV)" :area="Settings.orgaoid.domain" :samples="samples" :show-samples="false" />
              </q-tab-panel>

              <q-tab-panel :name="Tabs.svs.domain" class="q-py-sm q-px-none">
                <u-svs-tab title="Specimen Structural Variants (SV)" :area="Settings.orgaoid.domain" :samples="samples" :show-samples="false" />
              </q-tab-panel>
            </q-tab-panels>
          </div>
        </div>
