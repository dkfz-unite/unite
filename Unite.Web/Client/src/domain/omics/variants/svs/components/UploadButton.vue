<template>
  <u-upload-dialog
    ...
    templatePathJson="/templates/omics/svs.json"
    templatePathTsv="/templates/omics/svs.tsv"
    modelDocs="https://github.com/dkfz-unite/unite-omics-feed/blob/main/Docs/api-models-dna-sv.md"
