<template>
  <u-upload-dialog
    ...
    templatePathJson="/templates/omics/sms.json"
    templatePathTsv="/templates/omics/sms.tsv"
    modelDocs="https://github.com/dkfz-unite/unite-omics-feed/blob/main/Docs/api-models-dna-sm.md"
