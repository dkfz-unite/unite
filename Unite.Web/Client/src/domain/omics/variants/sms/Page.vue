  ...
  <div class="col q-gutter-y-sm">
    <div class="row">
      <q-breadcrumbs gutter="xs" class="text-subtitle1">
        ...
        <q-breadcrumbs-el :label="Settings.sms.crumb" />
      </q-breadcrumbs>
    </div>
...
const api = new VariantsApi(VariantType.SM);
...
export default {
  ...
  data() {
    return {
      ...
      model: FilterModels.Sm,
      models: [FilterModels.Donor, FilterModels.Mr, ...FilterModels.Specimens, FilterModels.Sm]
    };
  },
