<template>
  <div class="col q-gutter-y-sm">
    <div class="row">
      <span class="text-h5 u-text-title">Simple Mutations (SM)</span>
    </div>
    ...
    <div class="row q-col-gutter-sm q-pt-sm">
      ...
      <div class="col-12 col-sm-9 col-md-10">
        <u-data-table
          title="Gene Simple Mutations (SM)"
...
export default {
  ...
  data() {
    return {
      domain: this.$store.state.gene.sms,
      model: "sm",
      filters: filters
    }
  },
  ...
  methods: {
    async fetchData(searchCriteria) {
      return await api.searchVariants(this.gene.id, "sm", searchCriteria);
    }
  }
};
</script>