...
export default {
    ...
    return {
      ...
      newPassword: {
        ...
        rules: [
          ...
          (val) => stringHelpers.hasLowercaseLetter(val) || "Password should contain at least 1 lowercase letter",
          (val) => stringHelpers.hasUppercaseLetter(val) || "Password should contain at least 1 uppercase letter",
  ...
  computed: {
    ...
    canChangePassword(){
      var oldPasswordIsValid = this.oldPassword.rules.every(rule => 
        rule(this.oldPassword.value) === true);

      var newPasswordIsValid = this.newPassword.rules.every(rule => 
        rule(this.newPassword.value) === true);

      var newPsswordRepeatIsValid = this.newPasswordRepeat.rules.every(rule => 
  ...
  methods: {
    ...
    async onChangePassword() {
      try {
        ...
        var account = await apiClient.changePassword(this.oldPassword.value, this.newPassword.value, this.newPasswordRepeat.value);
