    ...
    return {
      columns: [
        ...
        },
        {
          ...
          field: (row) => contentHelpers.toBooleanString(row.organoid?.tumorigenicity),
          sortable: false,
          align: "left"
        },
        {
        ...
        },
        {
          ...
          field: (row) => contentHelpers.toBooleanString(row.organoid?.molecularData?.gcimpMethylation),
          sortable: false,
          align: "left",
          headerClasses: "bg-grey-2"
        },
